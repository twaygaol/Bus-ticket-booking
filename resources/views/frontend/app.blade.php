...
<body id="page-top">
  <div class="bg-green-900" style="height: 160px; border-bottom-left-radius: 50% 20px; border-bottom-right-radius: 50% 20px;">
    <nav class="navbar navbar-expand navbar-light topbar mb-4">
      <div class="container">
        ...
        <div class="title-text text-xl font-bold mx-3 text-white">PT AL MASAR</div>
        <ul class="navbar-nav ml-auto">
          <div class="topbar-divider d-none d-sm-block"></div>
          <li class="nav-item dropdown no-arrow text-gray-400 bg-white text-center p-1 text-sm rounded-sm">
  ...
  <div class="bg-gray-100 dark:bg-gray-900">
    ...
    <footer id="contact" class="bg-blue-100 py-20 md:py-40 relative">
        <div aria-hidden="true" class="absolute left-0 inset-0 grid grid-cols-2 -space-x-52 opacity-40 dark:opacity-5">
            <div class="h-56 bg-gradient-to-br from-primary to-green-400 blur-[106px] dark:from-green-700"></div>
            <div class="h-32 bg-gradient-to-r from-green-800 to-orange-400 blur-[106px] dark:to-indigo-600"></div>
        </div>
        <div aria-hidden="true" class="absolute right-0 inset-0 grid grid-cols-2 -space-x-52 opacity-40 dark:opacity-5">
            <div class="h-56 bg-gradient-to-br from-primary to-purple-400 blur-[106px] dark:from-blue-700"></div>
            <div class="h-32 bg-gradient-to-r from-blue-800 to-orange-400 blur-[106px] dark:to-indigo-600"></div>
        </div>
                ...
                <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                    <div class="flex w-full justify-center space-x-12 text-gray-600 dark:text-gray-300 sm:w-7/12 md:justify-start">
                        <ul class="list-inside list-disc space-y-8">
                            ...
                            <li><a href="#" class="transition hover:text-primary">Service</a></li>
                    ...
                    <div class="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
                        <span class="block text-black dark:text-gray-400">
                            Kenyamanan dan keselamatan adalah prioritas yang kami unggulkan
                        </span>

                        <span class="block text-black dark:text-gray-400">
                            PT Al MASAR &copy; <span id="year"><?php echo date('Y'); ?></span>
                        </span>
                        ...
                        <span class="block text-gray-500 dark:text-gray-400">
                            Need help? <a href="#" class="font-semibold text-gray-600 dark:text-white">Kontak kami</a>
                        </span>
                    </div>
                </div>
            </div>
